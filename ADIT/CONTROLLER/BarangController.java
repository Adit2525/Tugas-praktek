 ...
 */
package ADIT.CONTROLLER;

import ADIT.DAO.DaoBarang;
import ADIT.DAO.ImplementBarang;
import java.util.List;
import javax.swing.JOptionPane;
import javax.swing.table.TableModel;
import ADIT.MODEL.Barang;
import ADIT.MODEL.TabelBarang;
...
public class BarangController {
    ...
    public BarangController(FormBarang frame) {
        this.frame = frame;
        implbarang = (ImplementBarang) new DaoBarang();
    ...
    public void isiTable(){
        ...
        frame.getTabelBarang().setModel((TableModel) tb);
    }
